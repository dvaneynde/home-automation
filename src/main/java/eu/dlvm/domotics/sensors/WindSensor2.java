...
public class WindSensor2 extends Sensor implements IUiCapableBlock {
	 ...
	 *            Unit is seconds.
	 */
	public WindSensor2(String name, String description, String channel, IHardwareReader reader, IBlockRegistrar builder, int freqThreshold,
	...
	public WindSensor2(String name, String description, String ui, String channel, IHardwareReader reader, IBlockRegistrar builder,
