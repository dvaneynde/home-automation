...
public class LightSensor extends Sensor implements IUiCapableBlock {
	...
	public LightSensor(String name, String description, String ui, String channel, IHardwareReader reader, IBlockRegistrar builder, int threshold, int lowToHighDelaySec,
